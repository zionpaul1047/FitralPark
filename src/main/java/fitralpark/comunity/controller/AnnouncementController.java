...
public class AnnouncementController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		ArrayList<CommunityDTO> list = dao.Announcement_list(page, searchWord, pageSize, searchSel, searchCategory);
		...
		// 말머리 목록 조회
		ArrayList<CommunityDTO> headerList = dao.getAnnouncementHeaderList();

		// 요청 속성에 데이터 설정
		req.setAttribute("announcement_list", list);
