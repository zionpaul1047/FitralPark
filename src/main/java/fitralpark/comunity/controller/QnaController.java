...
public class QnaController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        ArrayList<CommunityDTO> list = dao.Qna_list(page, searchWord, pageSize, searchSel, searchCategory);
        
        // 전체 게시글 수 조회 (검색 조건 포함)
        int totalPosts = dao.getQnaTotalPosts(searchWord, searchSel, searchCategory);
        ...
        // 요청 속성에 데이터 설정
        req.setAttribute("qna_list", list);
