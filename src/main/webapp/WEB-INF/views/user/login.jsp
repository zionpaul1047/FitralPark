		...
		<div class="login_popup_box">
			...
			<div class="accounts_forms login_form w-100" id="login">
				...
				<form method="post" action="/login.do" class="form">
					...
					<div class="form-group">
						<label for="login_password">비밀번호</label> <i
					...
					<div class="form-group mb-0">
						...
						<button type="button"
							class="btn btn-secondary register_btn w-100 mt-2"
				...
				<div class="already_member_box d-flex justify-content-between px-2">
					...
					<div>
						<span name=findId id=findID>아이디 찾기</span> <span name=findPw
							id=findPw>비밀번호 찾기</span>
					</div>
				</div>
			</div>

			<div class="accounts_forms signup_form w-100" id="signup"
				style="display: none;">
				<div class="title text-center">
					<h1>회원가입</h1>
				...
				<form method="get" onsubmit="redirectToRegister(event)" class="form">
					<div class="form-group">
						<label for="name">이름</label> <input type="text" name="name"
							class="form-control" id="name" onfocus="labelUp(this)"
							onblur="labelDown(this)" required />
					</div>
					<div class="form-group">
						<label for="signup_email">이메일</label> <input type="email"
							name="email" class="form-control" id="signup_email"
							onfocus="labelUp(this)" onblur="labelDown(this)" required />
					</div>
					<div class="form-group">
						<label for="signup_password">비밀번호</label> <i
					...
					<div class="form-group">
						<label for="cpass">비밀번호 확인</label> <input type="password"
							name="cpass" class="form-control" id="cpass"
							onfocus="labelUp(this)" onblur="labelDown(this)" required />
					</div>
					<div class="form-group">
