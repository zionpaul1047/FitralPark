                ...
                <main>
                    <div id="mainbox">
                        <div id="smallbox">
                            ...
                            <form action="qnaPostEditOK.do" method="post" class="edit-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="header_no" required>
                                        ...
                                        <c:forEach items="${headerList}" var="header">
                                            <option value="${header.header_no}" ${header.header_no == dto.header_no ? 'selected' : ''}>${header.header_name}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="post_subject" value="${dto.post_subject}" required>
                                </div>
                                
                                <div class="form-group">
                                    <label>내용<span class="required">*</span></label>
                                    <textarea name="post_content" required>${dto.post_content}</textarea>
                                </div>
                                
                                <div class="privacy-check">
                                    <label>
                                        <input type="checkbox" name="privacy_check" value="Y" ${dto.privacy_check == 'Y' ? 'checked' : ''}>
                                        비밀글
                                    </label>
                                </div>
                                ...
                                <div class="button-group">
                                    ...
                                    <button type="button" onclick="location.href='qnaPost.do?post_no=${dto.post_no}'">취소</button>
                                </div>
                            </form>
                        </div>
                    </div>
