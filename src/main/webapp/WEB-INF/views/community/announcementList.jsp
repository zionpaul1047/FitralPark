			...
			<div class="grid_center_R">
				...
				<div id="mainbox">
					...
					<div id="board_etc_box">
						...
						<button type="button" id="btnadd_post" onclick="location.href='announcementWrite.do'">글쓰기</button>
					</div>
				</div>
